...
| 横竖屏 | 电视模式统一保持横屏，竖屏视频按原比例居中；手机竖屏播放页显示视频和紧凑播放面板，选集默认折叠为入口，点选集再打开分集面板；横屏采用视频与选集分栏。横屏视频随手机旋转进入全屏，也可手动全屏；退出后恢复方向跟随。全屏顶部只放返回和标题，底部统一提供播放、进度、选集、倍速 / 画质、设置、画中画和全屏；全屏设置与选集弹窗保持播放器暗色 |
